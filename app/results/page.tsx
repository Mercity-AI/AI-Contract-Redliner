...
import { ContractViewer, ContractViewerRef } from '@/components/contract-viewer';
import { IssuesSidebar, IssuesSidebarRef } from '@/components/issues-sidebar';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className={`transition-all duration-300 ${sidebarCollapsed ? 'pr-12' : 'pr-96'}`}>
        <div className="p-4 h-[calc(100vh-135px)]">
          <ContractViewer
